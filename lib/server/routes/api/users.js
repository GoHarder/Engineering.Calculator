...
lib.get = (data, callback) => {
   ...
   // TODO: 2-12-2021 3:31 PM - weird bug on forgot password request
...
lib.getWithEmail = (data, callback) => {
   ...
   mongo.app.collection('users').findOne({ email }, (error, userDoc) => {
      if (!error && userDoc) {
         ...
         // TODO: 2-10-2021 2:37 PM - set it as the input email
         const sent = emailService.sendResetEmail(['gharder@hwec.com'], { resetCode, baseUrl });
