...
// FIXME: 7-08-2021 12:50 PM - Remove or default the checkout value
// Go through all the routes and made sure that null is avoided
...
lib.getCustomer = async (data, callback) => {
   ...
   // You can add a limit to the length of customers returned within the pipeline
   // Add a set timeout
