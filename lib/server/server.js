...
lib.unifiedServer = (req, res) => {
   ...
   const { root, dir, file } = parse(path);
   ...
   req.on('end', () => {
      ...
      const chosenHandler = typeof lib.router[root] !== 'undefined' ? lib.router[root] : notFound;
      ...
      const data = {
         ...
         method,
         headers,
         payload: helpers.parseJsonStr(buffer),
      };
      ...
      chosenHandler(data, (statusCode, payload, contentType) => {
         ...
         res.setHeader('Content-Length', payloadString.length);
