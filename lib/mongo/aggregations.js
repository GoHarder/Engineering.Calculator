...
/** Creates an aggregation for the sling top channels */
...
/** Creates an aggregation for the sling bottom channels */
lib.getSlingBottomChannels = () => {
   return [
      { $match: { material: 'ASTM A36', depth: { $gte: 6 } } },
      {
         $addFields: {
...
/** Creates an aggregation for the sling sheave channels */
lib.getSlingSheaveChannels = () => {
   return [
      { $match: { material: 'ASTM A36', depth: { $gte: 6 } } },
      {
         $addFields: {
